...
class PathautoUnitTest extends KernelTestBase {
  ...
  public function testUpdateActions() {
    ...
    $this->assertAliasExists(array('source' => $node->urlInfo()->toString(), 'alias' => '/content/second-title'));
    ...
    $older_path = $this->assertAliasExists(array('source' => $node->urlInfo()->toString(), 'alias' => '/content/second-title'));
